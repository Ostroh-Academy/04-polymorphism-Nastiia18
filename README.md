...
**ВІдповідь**
В моєму коді не видно різниці  виконання програми з віртуальними методами та без віртуальних методів. Але ось особливості принципу їх роботи: звичайні методи функціонують статично: вони викликаються для типу об'єкта, відомого на етапі компіляції, і цей виклик не змінюється в час виконання. Це означає, що при використанні звичайних методів, програма "вирішує", який саме метод викликати, ще до того, як вона буде запущена.

Навпаки, віртуальні методи дозволяють динамічно вибирати, який саме метод викликати, залежно від типу об'єкта, який насправді знаходиться в пам'яті під час виконання програми. Таким чином, при використанні віртуальних методів, програма визначає, який метод викликати, у залежності від типу об'єкта, коли програма вже запущена. так буде правильно якщо я відправлю для свого завдання. Загалом при використанні звичайних методів, програма вже на етапі компіляції знає, який саме метод буде викликано, і виклик залишається статичним. Однак, використання віртуальних методів дозволяє вам динамічно визначати, який саме метод буде викликано в залежності від типу об'єкта на етапі виконання програми.
